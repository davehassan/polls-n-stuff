...
ActiveRecord::Schema.define(version: 20151015143807) do
  ...
  add_index "responses", ["responder_id", "question_id"], name: "index_responses_on_responder_id_and_question_id", unique: true
